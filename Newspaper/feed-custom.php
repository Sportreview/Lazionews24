...
>
	...
	<channel>
		...
		<!-- Feed Logo (optional) -->
		<image>
			<url>http://www.lazionews24.com/wp-content/uploads/2016/12/lazionews24-logo.png</url>
			<title>
		...
		$postlink   = '<br /><a href="' . get_permalink() . '">Leggi su Lazionews24.com</a><br /><br />';

		$news_content_raw = apply_filters('the_content', get_the_content());
		$news_content = $news_content_raw;	
