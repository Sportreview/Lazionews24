...
//Librerie VIMEO API
require("/home/lazionews24.com/htdocs/vimeophp/autoload.php");
...
function register_button($buttons) {
   array_push($buttons, "video_laz24");
   return $buttons;
}

function add_plugin($plugin_array) {
   $plugin_array['video_laz24'] = get_stylesheet_directory_uri().'/js/customcodes.js';
   return $plugin_array;
}
...
wp_enqueue_script( 'video_laz24_js', get_stylesheet_directory_uri().'/js/video_laz24.js' );
function video_laz24($atts, $content = null) {
...
add_shortcode("video_laz24", "video_laz24");
// END Video JS Engine | ARTICOLO


// Sliding Player
function videoslide_laz24($atts, $content = null) {
...
/*
  ...
  if (!isMobileNewtek && homepageURL=="https://www.lazionews24.com/") {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/lazionews24/hp/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/lazionews24/hp/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Lazionews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/lazionews.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885161&w=16&h=9';
  } else if (!isMobileNewtek) {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/lazionews24/altro/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/lazionews24/altro/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Lazionews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/lazionews.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885161&w=16&h=9';
  } else {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/lazionews24/mobile/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/lazionews24/mobile/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Lazionews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/lazionews.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=lazionews24.com&description_url=lazionews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885161&w=16&h=9';
  ...
  var settings = {
    logo: '<?php //echo site_url(); ?>/wp-content/themes/Newspaper-child/images/logo-laz24-video.png',
    logoLoc: '<?php //echo site_url(); ?>/',
    licenseKey: 'dG54dHd4aXh6aEAxNTA5NDU3',
    pathToRmpFiles: '//cdn.sportreview.it/radiantmp/latest/',
    gaTrackingId: 'UA-11488352-6',
  ...
  */
  ...
  <!-- Mediamatic | Special - 307x220 | 397 & 393 -->
  <div id='sy_37865' align='center'></div>
  <script>
    ...
    mmTag.push({mmSetPubId:393});
      mmTag.push({mmSetWeight:307});
      mmTag.push({mmSetHeight:220});
      }
    mmTag.push({mmSetDivId:'sy_37865'});
  ...
  add_shortcode("videoslide_laz24", "videoslide_laz24");
  //END Sliding Player


// Video Playlist
function video_playlist_laz24($atts, $content = null) {
    ...
    <div class="td-pb-row" style="padding: 0px 22px;">
      ...
      <script>
        var settings = {
          ...
          pathToRmpFiles: '//cdn.sportreview.it/radiantmp/latest/',
          licenseKey: 'dG54dHd4aXh6aEAxNTA5NDU3',
          skinAccentColor: '4face9',
          gaTrackingId: 'UA-11488352-6',
          gaCategory:'Video Playlist',
          delayToFade: 3000,
          debug: false,
          autoHeightMode: true,
...
add_shortcode("video_playlist_laz24", "video_playlist_laz24");
...
function adv_libs() { ?>
  ...
  if (!isMobileNewtek) {
    googletag.cmd.push(function() {
      googletag.defineSlot('/21624773413/Lazionews24.com/Mpu_Middle', [300, 250], 'div-gpt-ad-Mpu_Middle').addService(googletag.pubads());
      ...
      googletag.defineSlot('/67970281/display_thirdparty_it/lazionews24_responsive/ros/top_banner', [[1056, 250], [970, 250], [728, 90], [980, 250]], 'div-gpt-ad-1521732905256-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
      ...
      googletag.defineSlot('/67970281/display_thirdparty_it/lazionews24_responsive/ros/top_mpu', [[300, 250], [300, 600]], 'div-gpt-ad-1521732905256-3').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());  
...
jQuery("#div-gpt-ad-1521732832204-1").hide();
}
</script>
</div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521732905256-1' style='height:1px; width:1px;'>
      <script>
        if (!isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521732905256-1").hide();
        }
      </script>
    </div>
  <?php }
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521732832204-0").hide();
        }
      </script>
    </div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521732905256-0'>
      <script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521732905256-0").hide();
        }
      </script>
    </div>
  <?php }
...
function adv_top_desktop() { ?>
  <!-- /67970281/display_thirdparty_it/lazionews24_responsive/ros/top_banner -->
  <div id='div-gpt-ad-1521732905256-2'>
  <script>
    if (!isMobileNewtek) {
      googletag.cmd.push(function() { googletag.display('div-gpt-ad-1521732905256-2'); });
    } else {
      jQuery("#div-gpt-ad-1521732905256-2").hide();
    }
  </script>
  </div>
<?php }//adv_top_desktop
...
function adv_top_mobile_single() {
  if (is_single()) { ?>
    <script type="text/javascript">
    if (isMobileNewtek) {
      top_mobile_content = '<!-- /67970281/display_thirdparty_it/lazionews24_responsive/ros/top_mpu -->\
...
function adv_mpu_middle() { ?>
  <!-- /21624773413/Lazionews24.com/Mpu_Middle -->
...
function adv_overlay() { ?>
  <!-- /21624773413/Lazionews24.com/Overlay -->
